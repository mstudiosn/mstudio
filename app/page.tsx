...
<div className="absolute bottom-0 right-0 w-[900px] h-[500px] rounded-full bg-yellow-300/10 blur-[250px]"></div>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-12 py-1 bg-white/90 border-b border-gray-100 shadow-sm">
...
>
  <X size={32} className="text-black" />
      ...
      <motion.section
  id="accueil"
  className="relative flex flex-col items-center justify-center text-center pt-40 px-6 z-10"
...
>
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-yellow-200 bg-yellow-50 text-yellow-700 font-medium mb-8">
          🇸🇳 Design • Branding • Développement Web
         </div>
        <h1 className="text-5xl md:text-8xl font-bold text-[#111111] leading-tight">
  ...
  <a
    href="#services"
    className="bg-yellow-400 px-7 py-4 rounded-full font-semibold hover:bg-yellow-300 transition inline-block"
  >
  ...
  <a
  href="#projets"
  className="border border-black text-black px-7 py-4 rounded-full font-semibold hover:bg-black hover:text-white transition inline-block"
>
  Voir nos projets
</a>
</div>
  ...
  <div className="grid md:grid-cols-3 gap-8">
    ...
    <div className="bg-white p-10 rounded-3xl shadow-sm hover:-translate-y-2 hover:shadow-xl transition duration-300">
      <h3 className="text-3xl font-bold mb-4 text-black">Design</h3>
    ...
    <div className="bg-white p-10 rounded-3xl shadow-sm hover:-translate-y-2 hover:shadow-xl transition duration-300">
      <h3 className="text-3xl font-bold mb-4 text-black">Branding</h3>
      <p className="text-gray-600">
    ...
    <div className="bg-white p-10 rounded-3xl shadow-sm hover:-translate-y-2 hover:shadow-xl transition duration-300">
      <h3 className="text-3xl font-bold mb-4 text-black">Développement Web</h3>
      <p className="text-gray-600">
...
<section id="projets" className="py-32 px-8">
  ...
  <div className="grid md:grid-cols-3 gap-8">
    ...
    <div className="bg-[#111111] rounded-3xl h-96 p-8 text-white hover:-translate-y-2 transition duration-300">
  <Image
  src="/Branding2.png"
  alt="Branding"
  width={0}
...
/>
    ...
    <div className="bg-yellow-400 rounded-3xl h-96 p-8 text-black hover:-translate-y-2 transition duration-300">
     <Image
  src="/SiteVitrine.png"
  alt="Site vitrine"
  width={600}
...
/> 
    ...
    <div className="bg-white rounded-3xl h-96 p-8 shadow-sm hover:-translate-y-2 hover:shadow-xl transition duration-300">
      <Image
  src="/Affiche.png"
